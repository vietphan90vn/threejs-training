...
const tick = () => {
    ...
    objectsToTest.forEach((object) => {
        if (intersectObjects.includes(object)) {
    ...
    currentIntersect = intersects.length > 0 ? intersects[0] : null;

    currentIntersect ? console.log("Mouse enter") : console.log("Mouse leave");
